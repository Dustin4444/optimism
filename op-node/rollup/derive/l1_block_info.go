...
const (
	...
	L1InfoJovianLen            = L1InfoIsthmusLen + 4 // after Jovian upgrade, additionally pack in DA footprint gas scalar
)
...
type L1BlockInfo struct {
	...
	DAFootprintGasScalar uint32 // added by Jovian upgrade
}
